  ...
  return (
    <div className="detail-container flex-col">
      <div className="detail-nav flex-row align-right">
        <div className="detail-nav-btn active flex-row body-bld">
          Product Detail
        </div>
        <div className="detail-nav-btn unactive flex-row body-bld">
          Product Ingredients
        </div>
        <div className="detail-nav-btn unactive flex-row body-bld">
          How to use
      ...
      <div
        className={`detail-content flex-col gap-ms ${
          isExpanded ? "expanded" : ""
        }`}
      ...
      >
        ...
        {scrollPosition > detailContentHeight && (
          <i
            className={`expand-icon icon-size-20 ${iconState} ${
              isExpanded ? "expanded" : ""
            }`}
            onClick={handleClick}
          ></i>
