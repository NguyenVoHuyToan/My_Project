          ...
          <div className="bot-left-container">
            ...
            <div className="list-button">
              <div
                ...
                onClick={() => handleFunctionChange("accountInformation")}
              >
                <Button
                  text="ACCOUNT INFORMATION"
                  textStyle="btn-text-lgt"
                  btnStyle="underline-btn"
                  iconL="bi bi-person setting-icon"
                />
              </div>
              <div
                className="pay-option"
                onClick={() => handleFunctionChange("paymentInformation")}
              >
                <Button
                  text="PAYMENT INFORMATION"
                  textStyle="btn-text-lgt"
                  btnStyle="underline-btn"
                  iconL="bi bi-credit-card setting-icon"
                />
              </div>
              <div className="add-option">
                <Button
                  ...
                  textStyle="btn-text-lgt "
                  btnStyle="underline-btn"
                  iconL="bi bi-pin-map setting-icon"
                />
              </div>
              <div
                className="changepass-option"
                onClick={() => handleFunctionChange("changePassword")}
              >
                <Button
                  text="CHANGE PASSWORD"
                  textStyle="btn-text-lgt "
                  btnStyle="underline-btn"
                  iconL="bi bi-key setting-icon"
                />
              </div>
              ...
              <div className="logout-option">
                <Button
                  ...
                  textStyle="btn-text-lgt "
                  btnStyle="underline-btn"
                  iconL="bi bi-arrow-bar-left setting-icon"
                />
              </div>
            </div>
          </div>
            ...
            <div className="info-container">
              ...
              <form className="bot-right-body">
                <div className="bot-right-body1">
                  <label htmlFor="name-input" className="body-bld">
                    Full name
                  </label>
                  <label htmlFor="email-input" className="body-bld">
                    Email Address
                  </label>
                  <label htmlFor="phone-input" className="body-bld">
                    Phone Number
                  </label>
                  <label htmlFor="gender-input" className="body-bld">
                    Gender
                  </label>
                  <label htmlFor="date-input" className="body-bld">
                    Date of Birth
                  </label>
                </div>
              ...
              <div className="bot-right-btt">
                <Button
                  text="UPDATE"
                  btnStyle="auth-btn"
                  textStyle="btn-text-sml"
                  frameStyle="bot-right-btt-width"
              ...
              <div className="pay-body">
                ...
                <div className="pay-item-4">
                  ...
                  <p className="body-lgt">
                    Link with an existing bank or create a new account
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="info-container">
              ...
              <div className="cp-body">
                <div className="cp-label">
                  <label htmlFor="cp-email-input" className="body">
                    Email Address
                  </label>
                  <label htmlFor="current-password-input" className="body">
                    Current Password
                  </label>
                  <label htmlFor="new-password-input" className="body">
                    New Password
                  </label>
                  <label htmlFor="retype-new-password-input" className="body">
