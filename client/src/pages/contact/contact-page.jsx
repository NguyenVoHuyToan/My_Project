            ...
            <div class="C-column_3">
              ...
              <div>
                <div class="C-sub-column_3">
                  <label>
                    Need assistance or have questions? Don't hesitate to get in
              ...
              <div>
                <div class="C-sub-button_2">
                  ...
                  <div class="C-container-FAQ_1">
                    <label for="">
                      We highly value transparency and your well-being. Delve
                ...
                <div class="C-sub-button_2">
                  ...
                  <div class="C-container-FAQ_2">
                    <label>
                      Our commitment extends beyond quality skincare. We take
                ...
                <div class="C-sub-button_2">
                  <button class="C-button-FAQ_3">
                    <i class="bi bi-plus-circle"></i>
                    <label className="label-FAQ">
                      Do you offer any samples or trial sizes?
                    </label>
                  </button>
                  <div class="C-container-FAQ_3">
                    <label for="">
                      Discover our products firsthand with trial-sized samples
                ...
                <div class="C-sub-button_2">
                  <button class="C-button-FAQ_4">
                    <i class="bi bi-plus-circle"></i>
                    <label className="label-FAQ" for="">
                      How do I return or exchange an item?
                    </label>
                  </button>
                  <div class="C-container-FAQ_4">
                    <label for="">
                      We prioritize your satisfaction with our hassle-free
                ...
                <div class="C-sub-button_2">
                  ...
                  <div class="C-container-FAQ_5">
                    <label for="">
                      We provide detailed insights into our shipping procedures,
                ...
                <div class="C-sub-button_2">
                  ...
                  <div class="C-container-FAQ_6">
                    <label for="">
                      Choosing the perfect skincare product tailored to your
