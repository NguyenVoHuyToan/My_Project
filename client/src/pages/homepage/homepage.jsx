        ...
        <div className="homepage-first">
          ...
          <div className="hero-text flex-col gap-sm">
            <div className="title flex-col gap-sm">
              ...
              <div className="connect-with-radiant subtitle ">
                CONNECT WITH RADIANT BEAUTY
              </div>
            </div>
            <div className="content body">
              In a world where beauty never stops evolving, ShineAura is your
              destination to transform beauty into an art form. We bring
              diversity, quality, and style from renowned cosmetics brands
              worldwide. Join us in experiencing and expressing your unique
              beauty through the limitless choices at ShineAura.
            </div>
          </div>
        </div>
          ...
          <div className="home-product-container flex-col gap-md">
            <div className="text-product">
              ...
              <div className="at-shineaura-we body">
                At ShineAura, we take pride in offering a diverse collection of
                beauty products from world-renowned brands. Embrace and express
                your individual beauty with limitless choices from ShineAura.
              </div>
            </div>
            ...
            <div className="content-holder flex-col">
              <div className="about-us-content flex-col gap-md align-left">
                ...
                <div className="text-content body flex-col gap-sm">
                  <p>
                    Discover the pinnacle of beauty at ShineAura, where we
                    redefine the cosmetic experience beyond ordinary standards.
                    As your discerning companion on the journey to magnify and
                    honor your innatespirational force, urging you to explore
                    and indulge in the captivating world of beauty.
                  </p>
                  <p>
                    ShineAura not only delivers convenience but also presents a
                    meticulously chosen array of products, ensuring your diverse
                    beauty needs are met with unparalleled excellence. Beyond
                    cosmetics, we prioritize your satisfaction with the highest
                    standards of privacy and security, guaranteeing a seamless
