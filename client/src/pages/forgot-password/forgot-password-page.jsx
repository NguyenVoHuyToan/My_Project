          ...
          <form className="flex-col max-wdth align-left gap-sm">
            ...
            <div className="body-sml">
              <p>
                ...
                nobis voluptatibus molestiae sequi ipsam, laudantium obcaecati
                tenetur hic dolores, dolorum eum asperiores nihil. Recusandae,
                beatae iste? Architecto numquam nesciunt dicta.
              </p>
            </div>
          </form>
        </div>
